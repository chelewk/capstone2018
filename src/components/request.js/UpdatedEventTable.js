          ...
          {data.map(n => {
            return (
              <TableRow key={n.reqId}>
                ...
                <TableCell >{n.status==='update'? <HandleRequest data={n} /> : <p>Original Event</p>}</TableCell>
              </TableRow>
            );
          })}
        </TableBody>
...
UpdatedEvent.propTypes = {
  classes: PropTypes.object.isRequired,
};

export default withStyles(styles)(UpdatedEvent);